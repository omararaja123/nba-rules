"""
Phase 4: Evaluation with OpenAI
Test RAG system on 10 benchmark questions using OpenAI API.
"""
...
class OpenAIRAGEvaluator:
    """Evaluate RAG system using OpenAI."""
    ...
    def __init__(self, model: str = "gpt-4-turbo"):
        ...
        """
        self.rag = OpenAIRAGSystem(model=model)
        self.results = []
    ...
    def run_evaluation(self, verbose: bool = True) -> Dict:
        ...
        """
        print("=" * 80)
        print("PHASE 4: RAG EVALUATION WITH OPENAI")
        print("=" * 80)
        print()
    ...
    def save_evaluation(self, output_file: str = "data/evaluation_openai_results.json"):
        """Save results."""
        data = {
            "timestamp": datetime.now().isoformat(),
            "model": self.rag.model,
...
def main():
    """Run evaluation."""
    evaluator = OpenAIRAGEvaluator(model="gpt-3.5-turbo")
